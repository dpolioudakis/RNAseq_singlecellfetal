...
# Damon Polioudakis
# 2017-08-31
# Code to run Seurat_ClusterRound2.R
...
# qsub:
# qsub Seurat_ClusterRound2_QSUB.sh
#$ -cwd
#$ -V
#$ -S /bin/bash
#$ -N SeuratR2
#$ -o logs/Seurat_ClusterRound2_QSUB_$JOB_ID_$TASK_ID.log
#$ -e logs/Seurat_ClusterRound2_QSUB_$JOB_ID_$TASK_ID.error
#$ -l h_data=256G,h_rt=18:00:00,highp
#$ -t 1-1
################################################################################
echo ""
echo "Starting Seurat_ClusterRound2_QSUB.sh ${SGE_TASK_ID}... "$(date)
echo ""
##########################################################################
...
## Run Seurat_ClusterRound2.R
${pathRscript} Seurat_ClusterRound2.R && ${pathRscript} Seurat_ClusterRound2_MarkerPlots.R && ${pathRscript} Seurat_ClusterRound2DE.R
##########################################################################

echo ""
echo "End of Seurat_ClusterRound2_QSUB.sh ${SGE_TASK_ID}... "$(date)
##########################################################################
