# Damon Polioudakis
# 2017-10-03
# Submit list of genes to Vijays TF binding site enrichment pipeline TRANSFAC
################################################################################
...
## Output Directories
dir.create("../analysis/Seurat_ClusterDE_TFenrichment/TRANSFAC", recursive = TRUE)
################################################################################
...
write.csv(df, file = paste0(
  "../analysis/Seurat_ClusterDE_TFenrichment/TRANSFAC/Seurat_ClusterDE_TFenrichment_logFC04_Cluster"
...
print("Running for TRANSFAC...")

setwd("/u/home/d/dpolioud/project-geschwind/RNAseq_singlecellfetal/analysis/Seurat_ClusterDE_TFenrichment/TRANSFAC")

inFile <- paste0("Seurat_ClusterDE_TFenrichment_logFC04_Cluster", clusterID, ".csv")

TFBSenrich(user.file = inFile
  , TF.db = system.file("data/Clover_TRANSFAC", package = "RegFacEnc")
  , TF.nome = system.file(
    "data/TRANSFAC_JASPAR_NOMENCLATURE_TABLE", package = "RegFacEnc")
  , species = "Human", TF_motifs = "TRANSFAC", BF_Type = "Protein Coding"
  , pval = "0.05", option = "-t")

print("Done running for TRANSFAC...")
################################################################################
