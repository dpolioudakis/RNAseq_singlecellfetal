...
## Variables
graphCodeTitle <- "Seurat_FeaturePlot_MarkersforSingleCell_DS002003.R"
outGraphPfx <- "../analysis/graphs/Seurat_FeaturePlot_MarkersforSingleCell_DS002003"
...
# Loop through and plot each group of genes
pdf(paste0(outGraphPfx, "_CALB1_CALB2_PVALB_SST.pdf"), width = 13, height = 6)
