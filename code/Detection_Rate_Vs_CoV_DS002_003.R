...
## Variables
outGraphPfx <- "../analysis/graphs/Detection_Rate_Vs_CoV_DS002_003_"
graphCodeTitle <- "Detection_Rate_Vs_CoV_DS002_003.R"
...
pdf(paste0(outGraphPfx, "Vs_Mean.pdf"), width = 7, height = 5)
