...
# Variables
outGraph <- paste0("../analysis/graphs/WGCNA/DS2-11/Test_Parameters_SeuratCluster/WGCNA_Test_Parameters_SeuratCluster_", clusterID, "_")
outAnalysis <- paste0("../analysis/analyzed_data/WGCNA/DS2-11/Test_Parameters_SeuratCluster/WGCNA_Test_Parameters_SeuratCluster_", clusterID, "_")
graphCodeTitle <- "WGCNA_Test_Parameters_SeuratCluster.R DS2-11"
