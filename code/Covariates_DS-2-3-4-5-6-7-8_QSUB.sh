...
# Damon Polioudakis
# 2017-04-17
# Code to run Covariates_DS-2-3-4-5-6-7-8.R as array job

# Reminder:
#  make /logs directory in code directory

# qsub:
# qsub Covariates_DS-2-3-4-5-6-7-8_QSUB.sh
#$ -cwd
#$ -V
#$ -S /bin/bash
#$ -N Cov_Ds
#$ -o logs/Covariates_DS-2-3-4-5-6-7-8_QSUB_$JOB_ID.log
#$ -e logs/Covariates_DS-2-3-4-5-6-7-8_QSUB_$JOB_ID.error
#$ -l h_data=128G,h_rt=12:00:00,highp
################################################################################

echo ""
echo "Starting Covariates_DS-2-3-4-5-6-7-8.sh... "$(date)
echo ""
################################################################################
...
# Run Covariates_DS-2-3-4-5-6-7-8.R
echo "Running Covariates_DS-2-3-4-5-6-7-8.R..."
${pathRscript} Covariates_DS-2-3-4-5-6-7-8.R
################################################################################

echo ""
echo "End of Covariates_DS-2-3-4-5-6-7-8.sh... "$(date)
################################################################################
