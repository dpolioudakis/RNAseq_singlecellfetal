...
# Monocle object
inMo <- list.files("../analysis/Monocle_Round2/")
inMo <- inMo[grep("Monocle_Round2_Comp1-20_monocleO", inMo)]
moL <- lapply(inMo, function(path) {
  load(paste0("../analysis/Monocle_Round2/", path))
  return(mo_filtered)
})
# List names are Seurat clusters used for Monocle round 2
names <- gsub("Monocle_Round2_Comp1-20_monocleO_cluster", "", inMo)
...
# Pseudotime DE
inPtDE <- list.files("../analysis/Monocle_Round2/")
inPtDE <- inPtDE[grep("Monocle_Round2_Comp1-20_DEpseudotime_cluster", inPtDE)]
ptDeL <- lapply(inPtDE, function(path) {
  load(paste0("../analysis/Monocle_Round2/", path))
  return(ptDE)
})
# List names are Seurat clusters used for Monocle round 2
names <- gsub("Monocle_Round2_Comp1-20_DEpseudotime_cluster", "", inPtDE)
names <- gsub(".Robj", "", names)
names(ptDeL) <- names
...
# State DE
inStDE <- list.files("../analysis/Monocle_Round2/")
...
# List names are Seurat clusters used for Monocle round 2
names <- gsub("Monocle_Round2_Comp1-20_DEstate_cluster", "", inStDE)
names <- gsub(".Robj", "", names)
names(stDeLDF) <- names
# Reorder list of DE for plotting
...
# Branch DE
inBeam <- list.files("../analysis/Monocle_Round2/")
...
# List names are Seurat clusters used for Monocle round 2
names <- gsub("Monocle_Round2_Comp1-20_DEbranch_cluster", "", inBeam)
names <- gsub(".Robj", "", names)
...
outGraph <- "../analysis/graphs/Monocle_Round2_Analysis/Monocle_Round2_Analysis_Comp1-20_"
outTable <- "../analysis/tables/Monocle_Round2_Analysis/Monocle_Round2_Analysis_Comp1-20_"
outRdat <- "../analysis/Monocle_Round2_Analysis/Monocle_Round2_Analysis_Comp1-20_"
