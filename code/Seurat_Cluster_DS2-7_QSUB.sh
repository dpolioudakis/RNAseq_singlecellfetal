...
# Damon Polioudakis
# 2017-10-11
# Code to run Seurat_Cluster_DS-2-3-4-5-6-7.R as array job
# Task ideas should be number of times to run Seurat_Cluster_DS-2-3-4-5-6-7.R
# (e.g. -t 1-4)
...
# qsub:
# qsub Seurat_Cluster_DS-2-3-4-5-6-7_QSUB.sh
#$ -cwd
#$ -V
#$ -S /bin/bash
#$ -N Seurat
#$ -o logs/Seurat_Cluster_DS-2-3-4-5-6-7_QSUB_$JOB_ID_$TASK_ID.log
#$ -e logs/Seurat_Cluster_DS-2-3-4-5-6-7_QSUB_$JOB_ID_$TASK_ID.error
