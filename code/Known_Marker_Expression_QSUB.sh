...
# Damon Polioudakis
# 2017-08-31
# Code to run Known_Marker_Expression.R
...
# qsub:
# qsub Known_Marker_Expression_QSUB.sh
#$ -cwd
#$ -V
#$ -S /bin/bash
#$ -N KnownMks
...
################################################################################
echo ""
echo "Starting Known_Marker_Expression_QSUB.sh ${SGE_TASK_ID}... "$(date)
echo ""
##########################################################################
...
## Run Known_Marker_Expression.R
${pathRscript} Known_Marker_Expression.R
##########################################################################

echo ""
echo "End of Known_Marker_Expression_QSUB.sh ${SGE_TASK_ID}... "$(date)
##########################################################################
