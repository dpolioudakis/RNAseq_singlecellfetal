...
# Damon Polioudakis
# 2017-02-21
# qsub Seurat_PCA_Test_Function_DS002_003.R
...
# qsub:
# qsub Seurat_PCA_Test_Function_DS002_003_QSUB.sh
#$ -cwd
#$ -V
#$ -S /bin/bash
#$ -N StPcTest
#$ -o logs/Seurat_PCA_Test_Function_DS002_003_QSUB_$JOB_ID.log
#$ -e logs/Seurat_PCA_Test_Function_DS002_003_QSUB_$JOB_ID.error
#$ -l h_data=8G,h_rt=12:00:00
#$ -pe shared 6
################################################################################

echo "Starting Seurat_PCA_Test_Function_DS002_003_QSUB.sh ... "$(date)
################################################################################
...
echo ""
echo "Running Seurat_PCA_Test_Function_DS002_003.R..."
## Run Seurat_PCA_Test_Function_DS002_003.R
${RscriptPath} Seurat_PCA_Test_Function_DS002_003.R
################################################################################

echo ""
echo "End of Seurat_PCA_Test_Function_DS002_003_QSUB.sh ... "$(date)
################################################################################
